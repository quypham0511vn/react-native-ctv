...
const CurvedTabBarComponent = (props: TabBarViewProps) => {
    ...
    C${width + widthTab / 2 - SIZE_DOT * 0.5},0 ${width + widthTab / 2 - SIZE_DOT * 0.75
            },${HEIGHT_HOLE} ${width + widthTab / 2},${HEIGHT_HOLE} 
    C${width + widthTab / 2 + SIZE_DOT * 0.75},${HEIGHT_HOLE} ${width + widthTab / 2 + SIZE_DOT * 0.5
                ...
                {routes.map(({ key, title, ...configs }, index) => {
                    return (
                        <ButtonTab
                            ...
                            index={index}
                            isAuthTab={authTabIndexes.includes(index)}
